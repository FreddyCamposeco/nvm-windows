...
function Uninstall-NVM {function Uninstall-NVM {
    ...
    # Remover del PATH    # Remover del PATH
    ...
    # Remover del PATH del sistema (por si acaso)    # Remover del PATH del sistema (por si acaso)
    ...
    # Remover archivos principales    # Remover archivos principales
    ...
    # Remover alias del perfil de PowerShell    # Remover alias del perfil de PowerShell
    ...
    # Verificar si hay versiones instaladas    # Verificar si hay versiones instaladas
    ...
    if (Test-Path $versionsDir) {    if (Test-Path $versionsDir) {
        ...
        if ($versionFolders.Count -gt 0 -or $aliasFiles.Count -gt 0) {        if ($versionFolders.Count -gt 0 -or $aliasFiles.Count -gt 0) {
            ...
            # Si no hay versiones, eliminar el directorio completo            # Si no hay versiones, eliminar el directorio completo
